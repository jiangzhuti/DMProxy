...
public:
    platform_base(boost::asio::io_service &ios, std::string platform_name, std::string roomid) : m_close_callback(nullptr),
                                                                                                 m_ios(ios),
...
typedef std::function<platform_base_ptr_t(boost::asio::io_service&, std::string)> platform_creator_t;
